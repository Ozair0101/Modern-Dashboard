          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-blue-500/20 transition-all duration-300"
              >
                Send Message
              </motion.button>
            </form>
              ...
              <div className="space-y-4 mb-12">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">ozairjan186@gmail.com</p>
                  </div>
                </div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((link, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 rounded-full bg-gray-800 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-blue-400 hover:border-blue-500/30 transition-all duration-300"
